...
- [目录](目录.md)
- [序章上：为什么需要 FDE](序章上.md)
- [序章下：从模型能力到现场交付](序章下.md)
- [卷一：时代](卷一-时代.md)
- [卷二：定义](卷二-定义.md)
- [卷三：原则](卷三-原则.md)
- [卷四：方法](卷四-方法.md)
...
OpenTSC 共创者，在 X 平台使用“AI 最严厉的父亲”这一名称，关注企业 AI 转型、FDE 现场交付和商业实践。FDE 白皮书的原始手册由其发起并参与撰写。

### 黄小木（Jayce Huang）

前大厂 T11 工程师、全栈开发者，拥有 10 多年技术管理经验，曾在中科院、腾讯等机构任职。现专注企业 AI 转型 FDE、GEO 增长、Agent 定制和 AI 编程培训。他是 X 平台 4 万粉丝自媒体博主、酷喵记账 App 作者、阿里云人工智能训练师，也是海外自媒体增长工作流作者。
...
本仓库中的文章、图表和方法论材料采用 [Creative Commons Attribution-ShareAlike 4.0 International（CC BY-SA 4.0）](https://creativecommons.org/licenses/by-sa/4.0/) 授权。你可以分享和改编这些内容，但需要：

1. 保留作者署名和本仓库链接；
2. 标明是否做过修改；
3. 改编或汇编版本继续采用相同许可；
4. 不增加限制他人行使上述权利的法律或技术措施。

涉及项目案例时，请遵守脱敏、授权和撤回要求。公开版本不得包含能够识别客户的公司名、人名、地址、内部代号、原始账号或未授权的经营数据。客户可以提出撤回公开案例的要求，处理范围包括公开正文和附件。

完整说明见[使用与授权协议](USER_AGREEMENT.md)，许可摘要见 [LICENSE](LICENSE)。
